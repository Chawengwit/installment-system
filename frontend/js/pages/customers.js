(function ($) {
    ...
    const PageCustomers = {
        ...
        bindEvents: function () {
            ...
            $main.on("click", ".btn-view-customer", this.handleViewCustomer.bind(this));
            ...
            $main.on("click", ".btn-edit-customer", this.handleEditCustomer.bind(this));
        ...
        handleViewCustomer: function(e) {
            e.stopPropagation(); // Prevent event from bubbling to parent customer-card
